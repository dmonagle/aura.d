...
/// UDA attribute for command line help
struct CLHelpAttribute {
    string title;
    string description;
}
...
/// Use this to set the help text for a command line class or function
auto commandLineHelp(string title, string description = "") {
    return CLHelpAttribute(title, description);
}
...
void processCommandLine(C : Object)(C instance, string[] commands ...) {
    void printHelp() {
        static if (hasUDA!(instance, CLHelpAttribute)) {
            auto helpAttribute = getUDAs!(instance, CLHelpAttribute)[0];
            writeln("%s", helpAttribte.title);
        }
        else {
